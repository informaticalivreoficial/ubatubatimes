...
class PostController extends Controller
{
    ...
    //     $crawler->filter('.blog-items li')->each(function ($item) use ($client) {
    ...
    //             $data['content'] = $content . '<br>Fonte: <a target="_blank" href="https://www.ubatuba.sp.gov.br">Prefeitura de Ubatuba</a>';

    //             // 🖼️ IMAGEM (com fallback)
    //             $imageNode = $contentCrawler->filter('img')->first();

    //             $img = null;

    //             if ($imageNode->count()) {
    //                 $img = $imageNode->attr('src')
    ...
    //                 $img = 'https://www.ubatuba.sp.gov.br' . $img;
    //             }
    ...
    //                     $name = basename($img);
    //                     $path = env('AWS_PASTA') . 'noticias/' . $post->id . '/' . $name;
    ...
    //                     ]);
    //                 } else {
    //                     logger('Erro ao baixar imagem', ['url' => $img]);
    //                 }
    //             }

    //         } catch (\Exception $e) {
    //             logger('Erro no crawler', [
    //                 'titulo' => $titulo,
    //                 'erro' => $e->getMessage()
    //             ]);
    //         }
