...
<div class="row mb-2">
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{route('anuncios.categorias.index')}}">Categorias</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-teal card-outline">
                    <div class="card-body">
                        <form action="{{ route('anuncios.categorias.update', [ 'id' => $categoria->id ]) }}" method="post" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="row mb-4">
                            <div class="col-6">
