...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1><i class="fas fa-search mr-2"></i>Editar Anúncio</h1>
    </div>
    <div class="col-sm-6">
...
<form action="{{route('anuncios.update', [ 'id' => $anuncio->id ])}}" method="post" enctype="multipart/form-data">
@csrf
@method('PUT')
<div class="row">            
    <div class="col-12">
                        ...
                        <div class="row mb-2 text-muted">
                            ...
                            <div class="col-12 col-md-6 col-sm-6 col-lg-6"> 
                                <div class="form-group">
                                    ...
                                    <div class="thumb_user_admin">                                                    
                                        <img width="300" height="250" id="preview1" src="{{$anuncio->get300x250()}}" alt="{{ old('titulo') ?? $anuncio->titulo }}" title="{{ old('titulo') ?? $anuncio->titulo }}"/>
                            ...
                            <div class="col-12 col-md-6 col-sm-6 col-lg-6"> 
                                <div class="form-group">
                                    ...
                                    <div class="thumb_user_admin">                                                    
                                        <img width="468" height="90" id="preview2" src="{{$anuncio->get468x90()}}" alt="{{ old('titulo') ?? $anuncio->titulo }}" title="{{ old('titulo') ?? $anuncio->titulo }}"/>
                            ...
                            <div class="col-12 col-md-6 col-sm-6 col-lg-6"> 
                                <div class="form-group">
                                    ...
                                    <div class="thumb_user_admin">                                                    
                                        <img width="336" height="280" id="preview3" src="{{$anuncio->get336x280()}}" alt="{{ old('titulo') ?? $anuncio->titulo }}" title="{{ old('titulo') ?? $anuncio->titulo }}"/>
