...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1><i class="fas fa-search mr-2"></i>Cadastrar novo Projeto</h1>
    </div>
    <div class="col-sm-6">
...
<form action="{{ route('portifolio.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
@csrf          
<div class="row">            
<div class="col-12">
...
<div class="tab-content" id="custom-tabs-four-tabContent">
    <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                <div class="form-group">
                    <label class="labelforms text-muted"><b>*Categoria:</b> <a style="font-size:11px;" href="{{route('catprodutos.index')}}">(Cadastrar Categoria)</a></label>
            ...
            <div class="col-12 col-sm-6 col-md-3 col-lg-3">
                <div class="form-group">
                    <label class="labelforms text-muted"><b>Exibirno site?</b></label>
        ...
        <div class="row mb-2">
            <div class="col-12 col-sm-12 col-md-5 col-lg-4">
                <div class="form-group">
                    <label class="labelforms text-muted"><b>URL do site</b> <small class="text-info">(https://www.nomedosite.com)</small></label>
                    <input type="text" class="form-control text-muted" placeholder="URL do site" name="link" value="{{ old('link') }}">
                </div>
            </div> 
            ...
            <div class="col-12 col-md-6 col-lg-3"> 
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control datepicker-here" data-language='pt-BR' name="data_inicio" value="{{ old('data_inicio') ?? \Carbon\Carbon::now()->format('d/m/Y') }}"/>
            ...
            <div class="col-12 col-md-6 col-lg-3"> 
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control datepicker-here" data-language='pt-BR' name="data_termino" value="{{ old('data_termino') ?? \Carbon\Carbon::now()->format('d/m/Y') }}"/>
                        <div class="input-group-append">
                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                        </div>
                    </div>
            ...
            <div class="col-12 col-sm-12 col-md-5 col-lg-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control text-muted mask-money" name="valor" value="{{ old('valor') }}">
                </div>
            </div>                  
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-12">   
                ...
                <x-adminlte-text-editor name="content" v placeholder="Descrição do projeto..." :config="$config">{{ old('content') }}</x-adminlte-text-editor>                                                                                     
            </div>                        
        </div>
