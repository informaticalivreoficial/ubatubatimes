...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1><i class="fas fa-search mr-2"></i>Nova Fatura</h1>
    </div>
    <div class="col-sm-6">
                ...
                <div class="tab-content" id="custom-tabs-four-tabContent">
                            ...
                            <div class="col-12"> 
                                <div class="form-group">
                                    ...
                                    <div class="form-check d-inline mx-2">
                                        <input id="pf" class="form-check-input" type="checkbox" name="pfpf" {{(old('pfpf') == 'on' || old('pfpf') == 'true' ? 'checked' : '')}}>
                                        <label for="pf" class="form-check-label mr-5 text-muted">Pessoa Física</label>
                                        <input id="pj" class="form-check-input" type="checkbox" name="pfpj" {{(old('pfpj') == 'on' || old('pfpf') == 'true' ? 'checked' : '')}}>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-12 col-md-6 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control celularmask" name="telefone" value="{{old('telefone')}}">
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-3 pf">
                                <div class="form-group">
                                    <label class="labelforms text-muted"><b>CPF:</b> <small class="text-info">(campo obrigatório)</small></label>
                                    <input class="form-control cpfmask" name="cpf" value="{{old('cpf')}}">
                                </div>
                            </div>                                                                
                        </div>
                        <div class="row mb-2 pj">                            
                            ...
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="alias_name" value="{{old('alias_name')}}">
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label class="labelforms text-muted"><b>CNPJ:</b> <small class="text-info">(campo obrigatório)</small></label>
                                    <input class="form-control cnpjmask" name="cnpj" value="{{old('cnpj')}}">
                                </div>
                            </div>                                                                
                        </div>
                        <div class="row mb-2"> 
                            ...
                            <div class="col-3 col-md-3 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select name="tipo_boleto" class="form-control">
                                        <option value="boletoA4" {{ (old('tipo_boleto') == 'boletoA4' ? 'selected' : '') }}>boletoA4</option>
                                        <option value="boletoCarne" {{ (old('tipo_boleto') == 'boletoCarne' ? 'selected' : '') }}>Carnê</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-3 col-md-3 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select name="numero_parcelas" class="form-control">
                                        @php
                                            for ($x = 1; $x <= 12; $x++) {                                                
                                                echo '<option value='.$x.' '.(old('numero_parcelas') == $x ? 'selected' : '').'>'.($x == 1 ? 'á vista' : $x.' parcelas').'</option>';
                                            }
                                        @endphp
                                    </select>
                                </div>
                        ...
                        <div class="row mb-2">                                    
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="pedido" value="{{old('pedido')}}">
                                </div>
                            </div>                           
                        </div>                   
                    </div> 
                    ...
                    <div class="row text-right">
                        <div class="col-12 mb-4 mt-4">
                            ...
                            <button type="submit" class="btn btn-success"><i class="nav-icon fas fa-check mr-2"></i> Gerar Fatura</button>
                        </div>
                    </div> 
            </div>        
        </div>
